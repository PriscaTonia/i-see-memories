  ...
  return (
    <section className="font-hagrid">
      <div className="container lg:max-w-[90%] p-6 md:py-[60px] md:px-6 flex flex-col gap-4">
        ...
        <p>
          This website is operated by I see memories. Throughout the site, the
          terms “we”, “us” and “our” refer to I see memories. I see memories
        ...
        <p className="border-b pb-3">
          Our store is hosted on Shopware. They provide us with the online
        ...
        <p>
          ...
          &lsquo;comments&lsquo;), you agree that we may, at any time, without
        ...
        <p className="border-b pb-3">
          ...
          by our Privacy Policy, which can be viewed here: PRIVACY POLICY.
        </p>
        ...
        <p className="border-b pb-3">
          ...
          by us) provided &lsquo;as is&lsquo; and &lsquo;as available&lsquo; for
        ...
        <p className="border-b pb-3">
          You agree to indemnify, defend and hold harmless I see memories and
          ...
          suppliers, interns, and employees, from any claim or demand, including

...
const Reviews = () => {
  return (
    <section className="flex flex-col gap-[60px] bg-[#f6f6f6] py-[60px] px-[28px] font-hagrid">
      {/* first section */}
      ...
      <div className="flex flex-col gap-2 md:grid md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="flex flex-col justify-center items-center p-3 gap-2 bg-[#f1f0ed] col-span-1">
          ...
          <p className="text-[#666666] text-sm text-center">
            Just got my photobook from I see memories and it&apos;s an absolute
            game changer. It looks so stylish and really compliments my

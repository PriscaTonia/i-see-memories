...
const CreatePhotoBookSteps = () => {
  return (
    <section className=" bg-[#f6f6f6] font-hagrid">
      <div className="container p-[28px] md:p-[60px] flex flex-col gap-[60px]">
        {/* part 1 */}
        <div className="flex flex-col gap-3 lg:grid lg:grid-cols-2 lg:gap-x-[60px]">
          ...
          <p className="flex flex-col text-black text-base md:text-lg font-normal max-w-[616px]">
            With I see memories, you can easily transform your holiday photos
            into a stunning photobook that captures the essence of your journey.
            Simply upload your images, customize the layout, and add captions to
            create a unique keepsake that will transport you back to those
            special moments.
          </p>
        </div>
        {/* part 2 */}
